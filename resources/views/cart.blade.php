                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="@if($pdt->attributes->has('image')){{ asset($pdt->attributes->image) }}@endif" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" style="height:90px!important;">
                                        </a>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{ route('cart.decrement',['id' => $pdt->id]) }}" class="quantity-minus">-</a>
                                        <input title="Qty" class="email input-text qty text" type="text" value="{{ $pdt->quantity }}" placeholder="1" readonly>
                                        <a href="{{ route('cart.increment', ['id' => $pdt->id]) }}" class="quantity-plus">+</a>
                                    </div>
